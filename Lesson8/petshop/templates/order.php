<div class="page top-overlap">
    ...
    <form action="order.php" method="POST">
        ...
        <div class="form-group">
            ...
            <input id="dateCompleted" class="form-control" type="datetime" name="date_completed" value="<?= $order['date_completed']; ?>" disabled>
        </div>
    ...
    <table>
        ...
        <tbody>
            ...
            <tr>
                <td>
                    <a href="index.php?c=product&id=<?= $item['product']; ?>" title="View product">
                        <?= $item['name']; ?>
                    </a>
                </td>
