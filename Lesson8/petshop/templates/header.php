        ...
        <div class="row">
            ...
            <div class="col-lg-3 col-md-2 col-sm-3 col-xs-6 left-block">
                ...
                <?php if (!isset($_SESSION['login'])) { ?>
                    <a href="index.php?c=user">Log In</a>    
                <?php } else { ?>
                    <a href="index.php?c=user&id=<?= $currentUser['id']; ?>">Welcome, <?= $currentUser['login']; ?></a>
                <?php } ?>
                </div>
            </div>
            <div class="col-lg-3 col-md-2 col-sm-3 col-xs-6 right-block">
                <div class="top-links"><a href="index.php?c=shopping-cart">Shopping Cart: <?= sizeof($_SESSION['cart']); ?></a></div>
            </div>
