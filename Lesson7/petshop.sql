...
--
-- Хост: 127.0.0.1:3306
-- Время создания: Май 06 2019 г., 02:59
...
INSERT INTO `order_header` (`id`, `user`, `status`, `date_created`, `date_completed`, `cancelled`) VALUES
(2, 1, 'New', '2019-05-06 00:37:15', NULL, 0),
(3, 1, 'New', '2019-05-06 01:22:18', NULL, 0);
...
(1, 'admin', '21232f297a57a5a743894a0e4a801fc3', 'admin@user.com', NULL, NULL, 1),
(2, 'user', 'ee11cbb19052e40b07aac0ca060c23ee', 'user@user.com', 'John', 'Smith', 0);
